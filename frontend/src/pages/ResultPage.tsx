  ...
  const handleSaveSummaryEdit = () => {
    ...
    const patientDataRows = patientData
        ? [
            {
                label: "Geburtsdatum",
                value: `${formatOptionalValue(patientData.birthMonth)}/${formatOptionalValue(patientData.birthYear)}`
            },
            {
                label: "Größe / Gewicht",
                value: `${formatOptionalValue(patientData.height)} cm / ${formatOptionalValue(patientData.weight)} kg`
            },
            {label: "Geschlecht", value: formatGender(patientData.gender)},
            {label: "Schwangerschaft", value: patientData.isPregnant ? "Ja" : "Nein"},
            {label: "Stillzeit", value: patientData.isBreastfeeding ? "Ja" : "Nein"},
            ...
            <div className="bg-white border-2 border-[#486284] rounded-[16px] p-5 md:p-6 mb-4">
                ...
                <div className="bg-[#eff2f6] rounded-[12px] p-4 mb-4 space-y-3">
                        ...
                        {isEditingSummary && patientDataDraft ? (
                            <div className="grid gap-3 md:grid-cols-2">
                                ...
                                <div className="grid grid-cols-2 gap-3">
                                    <label
                                        className="flex items-center gap-2 rounded-[8px] border border-[#d8e0ea] px-3 py-2 text-sm font-bold text-app-text-body">
                                        <input
                                            type="checkbox"
                                ...
                                <div className="block">
                                    <span
                                        className="text-[11px] font-medium text-app-text-subtle">Substanzbeeinflussung</span>
                                    <select
                                ...
                                <label className="block md:col-span-2">
                                    <span
                                        className="text-[11px] font-medium text-app-text-subtle">Vorerkrankungen</span>
                                    <input
                    ...
                    <div className="bg-white rounded-[10px] p-3 border border-[#d8e0ea]">
                        ...
                        <div
                            className="space-y-2 font-['DM_Sans:Medium',sans-serif] font-medium text-app-text-body text-xs leading-relaxed">
                            {symptomDetails.length > 0 ? (
          ...
          {isEditingSummary && (
            ...
            <div className="bg-[#FEF3C7] border-l-4 border-[#F59E0B] rounded-[16px] p-5 md:p-6 mt-4">
                ...
                <p className="font-['DM_Sans:Medium',sans-serif] font-medium text-app-text-warning-strong text-sm leading-relaxed">
                    Diese Einschätzung ist <strong>keine medizinische Diagnose</strong> und ersetzt nicht den Besuch bei
                    einem Arzt.
                    KI-Systeme können Fehler machen. Bei Unsicherheit oder Verschlechterung Ihres Zustands suchen Sie
                    bitte
