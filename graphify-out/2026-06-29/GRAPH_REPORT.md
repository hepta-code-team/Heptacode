...
### Community 46 - "Frontend Vite Config"
Cohesion: 0.22
...
- **Why does `PatientData` connect `Frontend App & Assessment Flow` to `AI Adapter & Symptom Extraction`, `Triage Logic & Plausibility`, `Patient & Medical Data Forms`, `Assessment Service & FHIR Output`, `PDF Export Rendering`, `PDF/Triage Types & Review Prompt`, `Result Page Formatting`, `Triage Plausibility Live Tests`, `Symptom Extraction Normalization`, `Backend Benchmark Scripts`, `Frontend Recommendation Config`, `Triage Specialty Test Cases`, `Symptom Extraction API Client`, `Frontend Specialty Recommendation`, `Symptom Constants & Measurements`?**
  _High betweenness centrality (0.144) - this node is a cross-community bridge._
- **Why does `TriageSymptom` connect `Symptom Extraction Normalization` to `Frontend App & Assessment Flow`, `AI Adapter & Symptom Extraction`, `Triage Logic & Plausibility`, `Assessment Service & FHIR Output`, `PDF Export Rendering`, `Symptom Selection & Speech Input`, `PDF/Triage Types & Review Prompt`, `Triage Plausibility Live Tests`, `Backend Benchmark Scripts`, `Triage Specialty Test Cases`, `Symptom Extraction API Client`, `Frontend Specialty Recommendation`?**
  _High betweenness centrality (0.074) - this node is a cross-community bridge._
- **Why does `MedicalSpecialty` connect `Mental Health Extraction Contracts` to `Frontend App & Assessment Flow`, `Triage Logic & Plausibility`, `PDF Export Rendering`, `Nearby Practice Search`, `Result Page Formatting`, `Frontend Recommendation Config`, `Triage Specialty Test Cases`, `Symptom Extraction API Client`, `Symptom Constants & Measurements`?**
