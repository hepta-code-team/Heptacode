...
'Du extrahierst aus deutschem medizinischem Freitext bis zu drei Beschwerden in Erwähnungsreihenfolge.',
  ...
  '1. Pruefe zuerst, ob die Beschwerde sinngemaess zu einer vorhandenen Region oder Unteroption der Liste passt. Die Benennung muss nicht 1:1 gleich sein.',
  '2. Wenn die Beschwerde inhaltlich ausreichend von der Liste abgedeckt ist, nutze die passende vorhandene Region und, wenn passend, die passende Unteroption als side.',
  '3. Wenn keine vorhandene Region oder Unteroption die Beschwerde ohne relevanten Informationsverlust abdeckt, verwende die konkrete Beschwerde aus dem Freitext als eigene region.',
  ...
  'Beispiele fuer eigene Freitext-region, weil die Liste es nicht ausreichend abdeckt: "Husten", "Halsschmerzen", "Hautausschlag", "Blutiger Auswurf", "Blutiges Erbrechen".',
  'Bewahre medizinisch relevante Qualifikatoren im Freitext-Symptomnamen, zum Beispiel blutig, eitrig, brennend, anfallsartig, taub, geschwollen, juckend oder ausstrahlend.',
